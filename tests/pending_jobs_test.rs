//! Tests for Phase 6 RES-03: pending job pull on Pusher reconnect.
//!
...
// ── RES-03: fetch_pending_jobs empty array ───────────────────────────────────
...
// ── RES-03: fetch_pending_jobs non-200 ───────────────────────────────────────
